window.Physijs = (function() {
	...
	class HeightfieldMesh extends Physijs.Mesh {
	...
	// Physijs.BoxMesh
	class BoxMesh extends Physijs.Mesh {
		constructor( geometry, material, mass ) {
			super( geometry, material, mass );
	...
	// Physijs.SphereMesh
	class SphereMesh extends Physijs.Mesh {
		constructor( geometry, material, mass ) {
			super( geometry, material, mass );
	...
	class CylinderMesh extends Physijs.Mesh {
		constructor( geometry, material, mass ) {
			var width, height, depth;
	...
	// Physijs.CapsuleMesh
	class CapsuleMesh extends Physijs.Mesh {
		constructor( geometry, material, mass ) {
			var width, height, depth;
	...
	// Physijs.ConeMesh
	class ConeMesh extends Physijs.Mesh {
		constructor( geometry, material, mass ) {
			var width, height, depth;
	...
	// Physijs.ConcaveMesh
	class ConcaveMesh extends Physijs.Mesh {
		constructor( geometry, material, mass ) {
			var i,
				width, height, depth,
	...
	// Physijs.ConvexMesh
	class ConvexMesh extends Physijs.Mesh {
		constructor( geometry, material, mass ) {
			var i,
				width, height, depth,
				points = [];
